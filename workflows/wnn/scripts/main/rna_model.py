...
model = scvi.model.SCVI(
    adata, 
    n_latent=arg_dict['model_args']['n_latent'], 
    n_layers=arg_dict['model_args']['n_layers'], 
    n_hidden=arg_dict['model_args']['n_hidden'],
    dispersion=arg_dict['model_args']['dispersion'], 
    gene_likelihood=arg_dict['model_args']['gene_likelihood']
) 
